    ...
    for i, value in enumerate(value_list):
        ...
        if i == 0:
            ...
            value_combo_df = pd.merge(
                value_combo_df, temp_df, how="outer", left_index=True, right_index=True
            )
...
def get_value_quality(invest_df, fs_df, index_date, num):
    ...
    value_quality = pd.merge(
        value, quality, how="outer", left_index=True, right_index=True
    )
